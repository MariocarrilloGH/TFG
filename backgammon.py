...
class Partida:
    ...
    def movimiento(self,partida,dado):
        ...
        if (len(barra)==0):
            ...
            if (partida.es_posible(dado-1) and turno=='N'):
                movimientos.append((-1,abs(dado)))
            if (partida.es_posible(24+dado) and turno=='B'):
            ...
            for primera in primer_movimiento:
                ...
                for segunda in segundo_movimiento:
                    ...
                    if (segunda[0]==-1 or segunda[0]==24):
                        ...
                        (partida.tablero[segunda[0]]).remove(turno)
                    if (len(partida.tablero[posicion])==1 and partida.tablero[posicion]==rival):
                        (partida.barra_turno(rival)).append(rival)
                        partida.tablero[posicion] = []
                    if (0<=posicion<=23):
                    ...
                    for tercera in tercer_movimiento:
                        ...
                        if (tercera[0]==-1 or tercera[0]==24):
                            ...
                            (partida.tablero[tercera[0]]).remove(turno)
                        if (len(partida.tablero[posicion])==1 and partida.tablero[posicion]==rival):
                            (partida.barra_turno(rival)).append(rival)
                            partida.tablero[posicion] = []
                        if (0<=posicion<=23):

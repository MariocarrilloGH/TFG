...
class Partida:
    ...
    def imagen_tablero(self):
        tablero_vacio = Image.open("tablero_inicial.png")
        X = Image.open("X.png")
        O = Image.open("O.png")
        for i in range(0,3):
            for j in range(0,3):
...
"""partida = Partida()
arbol_juego = Arbol_juego(partida)
arbol_juego.llenar_arbol()

nodos = arbol_juego.nodos()
nodos_con_hijo = arbol_juego.nodos_con_hijo()

factor_ramificacion = (nodos-1)/nodos_con_hijo"""

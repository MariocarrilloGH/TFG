        ...
        while (not self.es_final()):
            ...
            if (not bool(jugadas_legales)):
                ...
                if (self.turno=='N'):
                    ...
                    aj, fila, columna = self.decision_maquina(aj,algoritmoN,profundidadN,ambosMCTS)
                    self.jugada(fila,columna)
                    self.imprimir_tablero() 
                else:
                    print(f"\nTurno de {algoritmoB} {profundidadB}")
                    aj, fila, columna = self.decision_maquina(aj,algoritmoB,profundidadB,ambosMCTS)
                    self.jugada(fila,columna)
                    self.imprimir_tablero()      
...
"""resultados1MM = []
v = [1,3,13,26,170,1200]
for i in [1,3,13,26,170,1200]:
    for j in v:
        posiciones = deepcopy(posiciones_iniciales)
...
resultados1MM = [((('MCTS', 1), 4), (('MCTS', 1), 6)),
((('MCTS', 1), 6), (('MCTS', 3), 4)), 
((('MCTS', 1), 3.0), (('MCTS', 13), 7.0)), 
((('MCTS', 1), 0), (('MCTS', 26), 10)), 
((('MCTS', 1), 0), (('MCTS', 170), 10)),  
((('MCTS', 1), 0), (('MCTS', 1200), 10)),
((('MCTS', 3), 7), (('MCTS', 3), 3)),
((('MCTS', 3), 2), (('MCTS', 13), 8)), 
((('MCTS', 3), 2), (('MCTS', 26), 8)), 
((('MCTS', 3), 0), (('MCTS', 170), 10)), 
((('MCTS', 3), 0), (('MCTS', 1200), 10)),
((('MCTS', 13), 3), (('MCTS', 13), 7)), 
((('MCTS', 13), 2), (('MCTS', 26), 8)), 
((('MCTS', 13), 1), (('MCTS', 170), 9)), 
((('MCTS', 13), 0), (('MCTS', 1200), 10)),
((('MCTS', 26), 7), (('MCTS', 26), 3)),
((('MCTS', 26), 2), (('MCTS', 170), 8)), 
((('MCTS', 26), 3), (('MCTS', 1200), 7)),
((('MCTS', 170), 4), (('MCTS', 170), 6)),
((('MCTS', 170), 1), (('MCTS', 1200), 9)),
((('MCTS', 1200), 6), (('MCTS', 1200), 4))]

resultados2MM = [((('MCTS', 3), 2), (('MCTS', 1), 8)),
((('MCTS', 13), 10), (('MCTS', 1), 0)),
((('MCTS', 26), 9), (('MCTS', 1), 1)),
((('MCTS', 170), 10), (('MCTS', 1), 0)),
((('MCTS', 1200), 10), (('MCTS', 1), 0)),
((('MCTS', 13), 5), (('MCTS', 3), 5)), 
((('MCTS', 26), 10), (('MCTS', 3), 0)), 
((('MCTS', 170), 10), (('MCTS', 3), 0)), 
((('MCTS', 1200), 10), (('MCTS', 3), 0)),
((('MCTS', 26), 7), (('MCTS', 13), 3)), 
((('MCTS', 170), 8), (('MCTS', 13), 2)),
((('MCTS', 1200), 10), (('MCTS', 13), 0)),
((('MCTS', 170), 10), (('MCTS', 26), 0)),
((('MCTS', 1200), 8), (('MCTS', 26), 2)),
((('MCTS', 1200), 9), (('MCTS', 170), 1))]

resultadosMM = [((('MCTS', 1), 14), (('MCTS', 3), 6)),
((('MCTS', 1), 3.0), (('MCTS', 13), 17.0)),
((('MCTS', 1), 1), (('MCTS', 26), 19)),
((('MCTS', 1), 0), (('MCTS', 170), 20)),
((('MCTS', 1), 0), (('MCTS', 1200), 20)),
((('MCTS', 3), 7), (('MCTS', 13), 13)),
((('MCTS', 3), 2), (('MCTS', 26), 18)),
((('MCTS', 3), 0), (('MCTS', 170), 20)),
((('MCTS', 3), 0), (('MCTS', 1200), 20)),
((('MCTS', 13), 5), (('MCTS', 26), 15)),
((('MCTS', 13), 3), (('MCTS', 170), 17)),
((('MCTS', 13), 0), (('MCTS', 1200), 20)),
((('MCTS', 26), 2), (('MCTS', 170), 18)),
((('MCTS', 26), 5), (('MCTS', 1200), 15)),
((('MCTS', 170), 2), (('MCTS', 1200), 18))] #Resultados de ejecutar el código de arriba     
...
((('MCTS', 1200), 20), (('random', 0), 0))] #Resultados de ejecutar el código de arriba
...
posiciones = deepcopy(posiciones_iniciales)
resultado = reversi_maquinas(posiciones,"random",0,"random",0)
resultados1AR.append(resultado)

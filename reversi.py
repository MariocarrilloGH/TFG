...
class Partida:
        ...
        while (not self.es_final()):
            ...
            if (not bool(self.jugadas_legales())):
                ...
                if (self.turno==jugador):
                    ...
                    print("\nTurno de la maquina")
                    aj, fila, columna = self.decision_maquina(aj,algoritmo,profundidad,iteraciones)
    ...
    def decision_maquina(self,aj,algoritmo,profundidad,iteraciones):
...
class Arbol_juego:
    ...
    def MCTS(self,iteraciones):
        ...
        while (iteracion<iteraciones):
            ...
            hoja.retropropagacion(self,resultado_simulacion)
            iteracion += 1
...
def reversi():
    ...
    if ((turno==1 or turno==2) and (algoritmo=="minimax" or algoritmo=="poda_ab" or algoritmo=="pvs" or algoritmo=="MCTS" or algoritmo=="random")):
        partida = Partida()
        partida.jugar(turno,algoritmo,profundidad,iteraciones)
...
class Partida:
    ...
    def imagen_tablero(self):
        tablero_vacio = Image.open("tablero_vacio_connect4.png")
        for i in range(0,6):
            for j in range(0,7):
                if (self.tablero[i][j]!='b'):
                    ...
                    if (self.tablero[i][j]=='N'):
                        ...
                        ficha.ellipse((coordenada_X, coordenada_Y, coordenada_X+31, coordenada_Y+31), fill = (255,29,0))
                    else:
                        ficha = ImageDraw.Draw(tablero_vacio)
                        ficha.ellipse((coordenada_X, coordenada_Y, coordenada_X+31, coordenada_Y+31), fill = (255,255,255))
        ...
        while (not self.es_final()):
            ...
            if (not bool(jugadas_legales)):
                ...
                if (self.turno=='N'):
                    ...
                    aj, columna = self.decision_maquina(aj,algoritmoN,profundidadN,ambosMCTS)
                    self.jugada(columna)
                    self.imprimir_tablero() 
                else:
                    print(f"\nTurno de {algoritmoB} {profundidadB}")
                    aj, columna = self.decision_maquina(aj,algoritmoB,profundidadB,ambosMCTS)
                    self.jugada(columna)
                    self.imprimir_tablero()
...
def connect4():
    ...
    algoritmo = input("Introduce el algoritmo (minimax o poda_ab o MCTS o random): ")
    if (algoritmo!="MCTS"):
        profundidad = int(input("Introduce la profundidad: "))
    else:
        profundidad = int(input("Introduce el número de iteraciones: "))
    if ((turno==1 or turno==2) and (algoritmo=="minimax" or algoritmo=="poda_ab" or algoritmo=="MCTS" or algoritmo=="random")):
        partida = Partida()
...
"""resultados1AM = []
for i in [3,4,5,6,7]:
    for j in [8,40,170,590,1750,20000]:
...
"""resultados1MM = []
v = [8,40,170,590,1750,20000]
for i in [8,40,170,590,1750,20000]:
    for j in v:
        posiciones = deepcopy(posiciones_iniciales)
...
resultados1MM = [((('MCTS', 8), 5), (('MCTS', 8), 5)),
((('MCTS', 8), 2), (('MCTS', 40), 8)),
((('MCTS', 8), 0), (('MCTS', 170), 10)),
((('MCTS', 8), 0), (('MCTS', 590), 10)),
((('MCTS', 8), 3), (('MCTS', 1750), 7)),
((('MCTS', 8), 1), (('MCTS', 20000), 9)),
((('MCTS', 40), 3), (('MCTS', 40), 7)),
((('MCTS', 40), 1), (('MCTS', 170), 9)),
((('MCTS', 40), 4), (('MCTS', 590), 6)),
((('MCTS', 40), 3), (('MCTS', 1750), 7)),
((('MCTS', 40), 3), (('MCTS', 20000), 7)),
((('MCTS', 170), 6), (('MCTS', 170), 4)),
((('MCTS', 170), 2), (('MCTS', 590), 8)),
((('MCTS', 170), 4), (('MCTS', 1750), 6)),
((('MCTS', 170), 5), (('MCTS', 20000), 5)),
((('MCTS', 590), 5), (('MCTS', 590), 5)),
((('MCTS', 590), 6), (('MCTS', 1750), 4)),
((('MCTS', 590), 5), (('MCTS', 20000), 5)),
((('MCTS', 1750), 5), (('MCTS', 1750), 5)),
((('MCTS', 1750), 6), (('MCTS', 20000), 4)),
((('MCTS', 20000), 5), (('MCTS', 20000), 5))]

resultados2MM = [((('MCTS', 40), 8), (('MCTS', 8), 2)),
((('MCTS', 170), 9), (('MCTS', 8), 1)),
((('MCTS', 590), 10), (('MCTS', 8), 0)),
((('MCTS', 1750), 10), (('MCTS', 8), 0)),
((('MCTS', 20000), 10), (('MCTS', 8), 0)),
((('MCTS', 170), 7), (('MCTS', 40), 3)),
((('MCTS', 590), 8), (('MCTS', 40), 2)),
((('MCTS', 1750), 8), (('MCTS', 40), 2)),
((('MCTS', 20000), 9), (('MCTS', 40), 1)),
((('MCTS', 590), 5), (('MCTS', 170), 5)),
((('MCTS', 1750), 5), (('MCTS', 170), 5)),
((('MCTS', 20000), 6), (('MCTS', 170), 4)),
((('MCTS', 1750), 4), (('MCTS', 590), 6)),
((('MCTS', 20000), 4), (('MCTS', 590), 6)),
((('MCTS', 20000), 6), (('MCTS', 1750), 4))]

resultadosMM = [((('MCTS', 8), 4), (('MCTS', 40), 16)),
((('MCTS', 8), 1), (('MCTS', 170), 19)),
((('MCTS', 8), 0), (('MCTS', 590), 20)),
((('MCTS', 8), 3), (('MCTS', 1750), 17)),
((('MCTS', 8), 1), (('MCTS', 20000), 19)),
((('MCTS', 40), 4), (('MCTS', 170), 16)),
((('MCTS', 40), 6), (('MCTS', 590), 14)),
((('MCTS', 40), 5), (('MCTS', 1750), 15)),
((('MCTS', 40), 4), (('MCTS', 20000), 16)),
((('MCTS', 170), 7), (('MCTS', 590), 13)),
((('MCTS', 170), 9), (('MCTS', 1750), 11)),
((('MCTS', 170), 9), (('MCTS', 20000), 11)),
((('MCTS', 590), 12), (('MCTS', 1750), 8)),
((('MCTS', 590), 11), (('MCTS', 20000), 9)),
((('MCTS', 1750), 10), (('MCTS', 20000), 10))] #Resultados de ejecutar el código de arriba
...
((('random', 0), 0), (('MCTS', 20000), 10))]

resultadosMR = [((('MCTS', 8), 15), (('random', 0), 5)),
((('MCTS', 40), 18), (('random', 0), 2)),
((('MCTS', 170), 20), (('random', 0), 0)),
((('MCTS', 590), 20), (('random', 0), 0)),
((('MCTS', 1750), 20), (('random', 0), 0)),
((('MCTS', 20000), 20), (('random', 0), 0))] #Resultados de ejecutar el código de arriba
...
posiciones = deepcopy(posiciones_iniciales)
resultado = connect4_maquinas(posiciones,"random",0,"random",0)
resultados1AR.append(resultado)
